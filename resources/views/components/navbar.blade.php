<div
    class="absolute hidden lg:block md:top-[180px] lg:top-[100px] xl:top-[130px] 2xl:top-[140px] md:left-[40px] lg:left-[30px] xl:left-[60px] 2xl:left-[75px] md:text-[21px] lg:text-[23px] xl:text-[27px] 2xl:text-[27px] text-[#ffffff] tracking-[1px]">
    <ul class="nav_list">
        <li class="nav_item flex items-center px-7 mt-7  {{ Route::is('home') ? 'active' : '' }} ">
            <a href="{{ route('home') }}" id="home"
                class="relative w-full h-full transition-all duration-[500ms] hover:text-[32px] hover:font-[700] bg-opacity-20">Home</a>
        ...
        <li class="nav_item flex items-center px-7 mt-7 {{ Route::is('about') ? 'active' : '' }}">
            <a href="{{ route('about') }}" id="about"
                class="relative w-full h-full transition-all duration-[500ms] hover:text-[32px] hover:font-[700]">About
                Us</a>
        ...
        <li class="nav_item flex items-center px-7 mt-7  {{ Route::is('service') ? 'active' : '' }}">
            <a href="{{ route('service') }}" id="services"
                class="relative w-full h-full transition-all duration-[500ms] hover:text-[32px] hover:font-[700]">Our
                Services</a>
        ...
        <li class="nav_item flex items-center px-7 mt-7 {{ Route::is('gallery') ? 'active' : '' }}">
            <a href="{{ route('gallery') }}" id="career"
                class="relative w-full h-full transition-all duration-[500ms] hover:text-[32px] hover:font-[700]">Gallery</a>
        ...
        <li class="nav_item flex items-center px-7 mt-7  {{ Route::is('whyUs') ? 'active' : '' }}">
            <a href="{{ route('whyUs') }}" id="people"
                class="relative w-full h-full transition-all duration-[500ms] hover:text-[32px] hover:font-[700]">Why
                Us?</a>
        ...
        <li class="nav_item flex items-center px-7 mt-7 {{ Route::is('contact') ? 'active' : '' }}">
            <a href="{{ route('contact') }}" id="contact"
                class="relative w-full h-full transition-all duration-[500ms] hover:text-[32px] hover:font-[700]">Contact
                Us</a>
